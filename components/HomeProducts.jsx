...
const HomeProducts = () => {
  ...
  return (
    <div className="flex flex-col items-center pt-14 px-6">
      ...
      <button onClick={() => { router.push('/all-products') }} className="px-12 py-2.5 border border-border-color rounded-lg text-text-secondary hover:bg-accent hover:text-text-primary transition-all duration-200">
        See more
      </button>
    </div>
  );
